...
temps_df["AvgTemperatureCelsius"] = (temps_df["AvgTemperatureFahrenheit"] - 32) * 5/9  # Convert from Fahrenheit to Celsius
...
if unique_countries_list is not None:
    ...
    selected_cities = st.multiselect("Select the cities to compare:", unique_countries_list, default=["Buenos Aires", "Munich"], max_selections=4)
